...
(setq *file-root* "/home/vc/jt/sys/lisp/.sparcf")
...
(set (default-pathname)  (make-pathname "/home/vc/jt/sys/oolong/" nil "ool"))
(load '(user imps))
(set compiler::*COMPILE-ORDINARIES* 'lisp:t)
(compile-imps)
(compile-file '(user init))
(compile-file '(user patch))
